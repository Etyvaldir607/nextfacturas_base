...
<tr>
	...
	<td style="width:50%;">
		...
		<tr>
			...
			<td><?php print $invoice->customer_id ?></td>
		</tr>
		</table>
	</td>
</tr>
...
<thead>
<tr>
	<th style="border:1px solid #000;">COD. PRODUCTO/SERVICIO</th>
...
<tr>
	...
	<td style="border:1px solid #000;">
		<div style="text-align:center;">
			<?php print siat_tipos_unidades_medida_buscar($item->unidad_medida_siat, $invoice->codigo_sucursal, $invoice->punto_venta)->descripcion; ?>
		</div>
	</td>
	<td style="border:1px solid #000;"><?php print $item->product_name ?></td>
	<td style="border:1px solid #000;">
...
<tr>
	<td style="width:80%;text-align:center;">
		...
		<br>
		<div><?php print $leyenda ?></div>
		<div>
			&quot;
			<?php //if( $invoice->tipo_emision == SiatInvoice::TIPO_EMISION_OFFLINE || $invoice->evento_id ): ?>
			<?php if( $invoice->tipo_emision == SiatInvoice::TIPO_EMISION_OFFLINE): ?>
