		...
		template: `<div id="com-sync-codigos">
			...
			<div class="row">
				<div class="col-12 col-sm-6">
					...
					<div class="form-group mb-3">
						<input type="text" name="" class="form-control" v-bind:value="cuis.fechaVigencia" />
					</div>
				</div>
				<div class="col-12 col-sm-6">
					<h3>CUFD</h3>
		...
		methods: 
		{
			...
			async obtenerCuis(renew)
			{
				try
				{
					...
					const res = await this.$root.api.Get('/../sistema/?/siat/synccodes');
					console.log('CUIS', res.data);
			...
			async obtenerCufd(renew)
			{
				...
				{
					this.$root.$processing.show('Obtenido datos...');
					const res = await this.$root.api.Get('/../sistema/?/siat/synccufd');
					this.$root.$processing.hide();
					this.cufd = res.data;
				}
				catch(e)
