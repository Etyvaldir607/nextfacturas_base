...
<div class="panel-body">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 text-right">
            <a href="?/operaciones/facturas_listar" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span><span class="hidden-xs"> Listar</span></a>
        </div>
    </div>
    <hr>
    <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <strong>Datos de la venta electrónica</strong>
                        </h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <form method="post" action="?/operaciones/facturas_guardar" class="form-horizontal">
                                ...
                                <div class="col-sm-8 col-sm-offset-4">
                                    <!-- <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="tipo" value="Devolucion" disabled> Devolución
                                        </label>
                                    </div> -->
                                    <div class="form-check form-check-inline mt-3">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="tipo" value="Reposicion" checked> Reposición
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <?php foreach ($detalles as $nro => $detalle) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap text-middle text-right" data-valor="<?= $detalle['id_detalle']; ?>">
                                            <?php echo '*(1)' . $detalle['unidad'].': ' . $otro_precio['costo']; ?>
                                            <!-- <?php $aux = '*1'; ?>
                                        ...
                                        <td class="text-nowrap text-middle">
                                            <button type="button" class="btn btn-xs btn-primary" data-vender="<?= $detalle['id_detalle']; ?>" data-toggle="tooltip" data-title="Devolver"><span class="glyphicon glyphicon-share-alt"></span></button>
        ...
        <?php } else { ?>
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="glyphicon glyphicon-home"></i> Devolucion ventas electrónicas</h3>
                    </div>
                    <div class="panel-body">
                        <div class="alert alert-danger">
                            <strong>Advertencia!</strong>
