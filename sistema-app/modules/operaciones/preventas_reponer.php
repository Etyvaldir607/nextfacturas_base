    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
				...
				<form method="post" action="?/operaciones/preventas_reponer_guardar" class="form-horizontal" id="send-form">
                                    ...
                                    <tr data-busqueda="<?= $producto['id_producto'] .'_'. $producto['id_detalle']; ?>">
										...
										*(10)BOLSA:1000.00 -->
										...
										<td class="text-nowrap text-middle text-center width-none">
											...
											<button type="button" class="btn btn-default" data-actualizar="<?= $producto['id_producto'] .'_'. $producto['id_detalle']; ?>" onclick="actualizar(this, <?= $ingreso['almacen_id'] ?>);">
											<span class="glyphicon glyphicon-refresh"></span>
											<!--Actualizar-->
											</button>
										</td>
