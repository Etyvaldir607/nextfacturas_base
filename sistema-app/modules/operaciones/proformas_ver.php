...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-9 text-right">
			...
			<a href="?/operaciones/proformas_listar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs hidden-sm"> Listar</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
					...
					<div class="table-display">
						<div class="tbody">
							<div class="tr">
								...
								<div class="td"><?= escape(date_decode($proforma['fecha_proforma'], $_institution['formato'])) . ' ' . escape($proforma['hora_egreso']); ?></div>
							</div>
							<div class="tr">
						...
						<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    ?>
									<?php $importe = ($cantidad * $precio) - $detalle['descuento'] ?>
