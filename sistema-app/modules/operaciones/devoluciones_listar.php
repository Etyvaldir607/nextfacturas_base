<?php
    ...
    $devoluciones = $db->query("select  i.*, a.almacen, a.principal, CONCAT(e.nombres,' ', e.paterno, ' ' , e.materno) as empleado, 
                                        SUM(d.cantidad*d.costo)as monto_total_2, COUNT(d.id_detalle)as nro_detalles, eg.nro_nota
                               from inv_ingresos i
                    ...
                    <tbody>
                        <?php foreach ($devoluciones as $key => $devol) { ?>
                            <tr>
                                ...
                                <td class="">
                                    <a href="?/ingresos/ver/<?= $devol['id_ingreso'] ?>" target='_blank' data-toggle='tooltip' data-title='Ver detalle' >
    ...
    <?php if ($permiso_cambiar) { ?>
        ...
        $.validate({
            ...
            onSuccess: function () {
                ...
                window.location = '?/operaciones/devoluciones_listar' + inicial_fecha + final_fecha;
            }
        });
