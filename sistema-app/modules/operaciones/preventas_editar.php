...
$detalles = $db->query("SELECT a.*, b.*, a.unidad_id AS unidad_det, GROUP_CONCAT(c.unidad_id, '*',d.unidad, '*', c.otro_precio SEPARATOR '|') AS prec
	...
	LEFT JOIN inv_unidades d ON c.unidad_id = id_unidad WHERE a.egreso_id = '$id_egreso' GROUP BY a.id_detalle")->fetch();
...
//                                        if($detalle['prec']){?>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <input type="text" name="monto_total" value="0" class="translate" tabindex="-1" data-total="" data-validation="required number" data-validation-allowing="range[0.01;10000000.00],float" data-validation-error-msg="El monto total de la venta debe ser mayor a cero y menor a 10000000.00">
                            </div>
                        </div>
                        <div class="form-group">
