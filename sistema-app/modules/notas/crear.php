			...
			<div class="panel panel-warning">
				...
				<div class="panel-body">
					...
					<form id="formulario" class="form-horizontal">
						...
						<!--	<div class="col-sm-8">-->
								<input type="hidden" value="" name="nit_ci" id="nit_ci" class="form-control text-uppercase" autocomplete="off" ><!--data-validation="required number"-->
						<!--	</div>-->
						<!--</div>-->
						<div class="form-group">
						...
						<!-- <div class="form-group" id="para_pagos">
							...
							<div class="col-sm-8">
								<div class="row">
									<div class="col-md-7"> -->
                                        <input type="text" name="nro_pago" id="nro_pago" value="0" placeholder="Nro documento" class="form-control" autocomplete="off" data-validation="number" aria-label="..." data-validation-optional="true">
                                        <!-- <input type="text" name="nro_pago" id="nro_pago" value="<?= $nro_factura ?>" placeholder="Nro documento" class="form-control" autocomplete="off" data-validation="number" aria-label="..." data-validation-optional="true"> -->
                                    <!-- </div>
								</div>
							</div>
						...
						<input type="hidden" value="EFECTIVO" name="tipo_pago" id="tipo_pago"> 
	...
	<?php } else { ?>
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<div class="alert alert-danger">
						<p>Usted no puede realizar notas de venta, verifique que la siguiente información sea correcta:</p>
						<ul>
