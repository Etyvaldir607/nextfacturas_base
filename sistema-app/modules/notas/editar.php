								...
								<tbody>
								    ...
								    <tr class="active" data-producto="<?= $id_productox ?>">
                            			...
                            			<td class="text-nowrap text-middle">
                            			    <input type="text" value="<?= $detalleX['producto_id'] ?>" name="productos[]" class="translate input-xs" tabindex="-1" data-validation="required number" data-validation-error-msg="Debe ser número">
                                        ...
                                        <td class="text-middle">
				                            <input type="text" value="<?= $detalleX['unidad'] ?>" data-xyyz="<?= $lote_cantidad['lote_cantidad'] ?>" name="unidad[]" class="form-control input-xs text-right" autocomplete="off" data-unidad="' + parte[0] + '" readonly data-validation-error-msg="Debe ser un número decimal positivo">
				                        </td>
				                        <td class="text-middle" data-xyyz="<?= $lote_cantidad['lote_cantidad'] ?>" >
                                            ...
                                            if($_user['rol_id'] != '1') {
                            	                ...
                            	                ?>			
                                    				<input type="text" readonly value="<?= $detalleX['precio'] ?>" name="precios[]" class="form-control input-xs text-right" autocomplete="off"  data-precio="<?= $detalleX['precio'] ?>" data-cant2="1"   data-validation-error-msg="Debe ser un número decimal positivo">
                                    				<input type="text" readonly value="<?= $detalleX['precio'] ?>" name="pre[]" class="form-control input-xs text-right hidden" autocomplete="off"  data-pre="<?= $detalleX['precio'] ?>" data-cant2="1"   data-validation-error-msg="Debe ser un número decimal positivo">
                                    			?>
                                    			}else{
                                    			?>
                                    				<input type="text" value="<?= $detalleX['precio'] ?>" name="precios[]" class="form-control input-xs text-right" autocomplete="off"  data-precio="<?= $detalleX['precio'] ?>" data-cant2="1"   data-validation-error-msg="Debe ser un número decimal positivo" onkeypress="SetEnter(event);" onkeyup="modificar_precio('<?= $id_productox ?>'); calcular_importe('<?= $id_productox ?>')">
                                    			    <input type="text" value="<?= $detalleX['precio'] ?>" name="pre[]" class="form-control input-xs text-right hidden" autocomplete="off"  data-pre="<?= $detalleX['precio'] ?>" data-cant2="1"   data-validation-error-msg="Debe ser un número decimal positivo" onkeyup="modificar_precio('<?= $id_productox ?>'); calcular_importe('<?= $id_productox ?>')">
                            				    <?php
                                                }
                                            }else{
                                            ?>			
    				                        ...
    				                        <input type="hidden" value="" readonly name="asignaciones[]" class="form-control input-xs text-right" autocomplete="off" data-asignacion="" data-validation-error-msg="Debe ser un número decimal positivo">
				                        </td>
