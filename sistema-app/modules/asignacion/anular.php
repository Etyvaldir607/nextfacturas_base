<?php
    ...
    if ($preventa) {
        ...
        if ($preventa['preventa'] == 'anulado') {
            ...
            set_notification('warning', 'Accion insatisfactoria!', 'No se puede realizar esta acción, la preventa ya fue anulada.');
            ...
            if ($preventa['nro_nota'] != 0) {
                ...
                $movimiento = generarMovimiento($db, $_user['persona_id'], 'DV', $preventa['almacen_id'] );
            ...
            set_notification('success', 'Accion satisfactoria!', 'La preventa fue anulada satisfactoriamente.');
