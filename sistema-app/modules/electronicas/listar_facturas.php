...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 text-right">
            ...
            <?php if ($permiso_crear) { ?>
            <a href="?/electronicas/libro_ventas" class="btn btn-success">
                <span class="glyphicon glyphicon-plus"></span><span class="hidden-xs"> Libro de Ventas</span>
            </a> 
            <?php } ?>
		</div>
	</div>
	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		<thead>
			<tr class="active">
                ...
                <th class="text-nowrap">NIT/CI/CEX:</th>
		...
		<tfoot>
			<tr class="active">
                ...
                <th class="text-nowrap text-middle" data-datafilter-filter="true">NIT/CI/CEX:</th>
