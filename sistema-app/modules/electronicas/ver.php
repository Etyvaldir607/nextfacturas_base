...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/electronicas/imprimir_nota/<?= $id_venta; ?>" target="_blank" class="btn btn-info"><span class="glyphicon glyphicon-print"></span><span class="hidden-xs hidden-sm"> Imprimir</span></a>
			<?php } ?>
			...
			<a href="?/electronicas/mostrar" class="btn btn-primary"><span class="glyphicon glyphicon-list-alt"></span><span class="hidden-xs hidden-sm hidden-md"> Notas de venta</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
	...
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
						...
						<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class=""><?= escape($detalle['nombre_factura']); ?></td>
					...
					<div class="alert alert-danger">
						...
						<p>Esta nota de venta no tiene detalle, es muy importante que todos los egresos cuenten con un detalle que especifique la operación realizada.</p>
					</div>
					<?php } ?>
				</div>
			</div>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><span class="glyphicon glyphicon-log-out"></span> Información de la nota de venta</h3>
				</div>
				<div class="panel-body">
	...
	$('[data-reimprimir]').on('click', function () {
		...
		$.ajax({
			...
			if (venta) {
				...
				$.notify({
					title: '<strong>Error!</strong>',
					message: '<div>Ocurrió un problema al obtener los datos de la nota de venta.</div>'
				}, {
					type: 'danger'
				});
			}
