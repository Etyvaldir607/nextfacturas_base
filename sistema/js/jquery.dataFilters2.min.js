		...
		$tables.each(function (nro) {
			...
			$('#report_excel_' + nro).on('click', function (e) {
				...
				if (Modernizr.datauri && Modernizr.adownload) {
					...
					file += '</head>';
					file += '<body>';
                    file += '<table><tr><td colspan="8" align="Center"><h1>' +options.name+ '</h1></td></tr><tr><td align="left"  colspan="8"><h4>' +options.empresa+ '</h4></td></tr><tr><td  colspan="8"><h4>' +options.direccion+ '</h4></td></tr><tr><td  colspan="8"><h4>' +options.telefono+ '</h4></td></tr></table>';
