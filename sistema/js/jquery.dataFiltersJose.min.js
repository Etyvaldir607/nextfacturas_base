		...
		$tables.each(function (nro) {
			...
			$('#report_excel_' + nro).on('click', function (e) {
				...
				if (Modernizr.datauri && Modernizr.adownload) {
					...
					file += '</head>';
					file += '<body>';
                    file += '<table><tr><td colspan="12" align="Center"><h1>' +options.name+ '</h1></td></tr><tr><td align="left"  colspan="12"><h4>' +options.empresa+ '</h4></td></tr><tr><td  colspan="12"><h4>' +options.direccion+ '</h4></td></tr><tr><td  colspan="12"><h4>' +options.telefono+ '</h4></td></tr><tr><td colspan="3"></td><td align="right"><h4>Cliente: </h4></td><td colspan="2" align="center">' +options.cliente+ '</td><td align="right"><h4>NIT/C.I.: </h4></td><td colspan="2" align="center">' +options.nit_ci+ '</td><td colspan="3"></td></tr><tr><td colspan="12"></td></tr></table>';
			...
			$('#report_word_' + nro).on('click', function (e) {
				...
				if (Modernizr.datauri && Modernizr.adownload) {
					...
					file += '</head>';
					file += '<body>';
                    file += '<table width="100%" border="0"  style="font-size:14px"><tr><td colspan="5"><img id="img-0" src="' + options.imag + '" height="50" ></td><td align="right" colspan="8">' +options.empresa+ '<br>' +options.direccion+ '<br>' +options.telefono+ '</td></tr><tr><td colspan="5"></td><td align="right"><h4>Cliente: </h4></td><td colspan="2" align="left">' +options.cliente+ '</td><td align="right"><h4>NIT/C.I.: </h4></td><td colspan="2" align="left">' +options.nit_ci+ '</td><td colspan="3"></td></tr><tr><td colspan="11"></td></tr></table>';
					file += '<table cellspacing="0" cellpadding="0" border="1" style="font-size:11px">' + thead + tbody + '</table>';
					file += '</body>';
					file += '</html>';
			...
			$('#report_html_' + nro).on('click', function (e) {
				...
				'<html lang="en">' +
					...
					'<table width="100%" border="0" ><tr><td align="right">Cliente: </td><td align="left">' + options.cliente + '</td><td align="right">NIT/CI.I:</td><td align="left">' + options.nit_ci + '</td></tr></table>' +
						table +
					'</body>' +
				'</html>';
